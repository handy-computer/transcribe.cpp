...
export const PUBLIC_HEADER_HASH = "3ba8dde028c487b6";
...
export function defineTypes(koffi: any): Record<string, any> {
  ...
  T['transcribe_run_params'] = koffi.struct({ struct_size: 'uint64_t', task: 'int', timestamps: 'int', pnc: 'int', itn: 'int', language: 'char *', target_language: 'char *', keep_special_tags: 'bool', family: 'void *', spec_k_drafts: 'int32_t', context: 'char *' });
