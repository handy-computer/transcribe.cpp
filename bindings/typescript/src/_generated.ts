...
export const PUBLIC_HEADER_HASH = "8622da005d6a6fcc";
...
export function defineTypes(koffi: any): Record<string, any> {
  ...
  T['transcribe_run_params'] = koffi.struct({ struct_size: 'uint64_t', task: 'int', timestamps: 'int', pnc: 'int', itn: 'int', diarize: 'int', language: 'char *', target_language: 'char *', keep_special_tags: 'bool', family: 'void *', spec_k_drafts: 'int32_t', n_allowed_languages: 'int32_t', allowed_languages: 'void *' });
