...
//!
//! 1. **dylib rpath.** In the `dylib` (shared) posture the consumer binary must
...
//!    a Windows dylib consumer puts the lib dir on PATH instead.
...
fn main() {
    ...
    let dylib = env::var_os("CARGO_FEATURE_DYLIB").is_some();
