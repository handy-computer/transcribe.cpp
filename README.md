...
| Granite Speech 5.0 TurboCTC | `granite-speech-5.0-470m-turboctc` (Apache-2.0), `granite-speech-5.0-470m-turboctc-nc` (non-commercial) | [docs/models/granite-speech-5.0-turboctc.md](docs/models/granite-speech-5.0-turboctc.md) |
