...
Usage:
    ...
    uv run scripts/hf_cards/generate.py scripts/hf_cards/parakeet-tdt-0.6b-v2.yaml -o dist/README.md
"""
...
def main() -> int:
    ...
    ap.add_argument("-o", "--output", type=Path, help="Write to this path instead of stdout")
    ap.add_argument(
        "--skip-upstream",
        action="store_true",
