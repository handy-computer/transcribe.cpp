...
| CPU     | jfk (11.0s)  | 346 ms (31.77×) | 345 ms (31.89×) |
| CPU     | dots (35.3s) | 1.18 s (30.02×) | 1.16 s (30.52×) |

Apple M4 Max: transcribe.cpp `c2e7bf9` on 2026-05-11. † published before provenance was recorded; not yet re-measured.
<!-- /catalog -->
