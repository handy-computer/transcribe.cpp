...
| ------- | --------- | --------------: | --------------: |
| Metal   | ru (4.5s) | 16 ms (284.76×) | 16 ms (285.73×) |
| CPU     | ru (4.5s) | 146 ms (30.74×) | 146 ms (30.83×) |
...
| Backend | Sample    |            Q8_0 |          Q4_K_M |
| ------- | --------- | --------------: | --------------: |
| Vulkan  | ru (4.5s) | 166 ms (27.11×) | 170 ms (26.49×) |
| CPU     | ru (4.5s) | 352 ms (12.77×) | 402 ms (11.20×) |
